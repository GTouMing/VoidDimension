...
public class TerminalPage1 extends BTerminalPage {
    ...
    protected List<TickAbstractWidget> createComponents() {
        ...
        TickAbstractWidget powerLabel = new TickString(xOffset, yOffset, 160, font)
                .updateMessage(() -> Component.translatable("gui.void_dimension.terminal.page1.total_power", "§b" + GuiS2CPacket.getTotalPowerLevel()))
                .alignLeft();
        ...
        TickAbstractWidget dimValueLabel = new TickString(
                ...
                .updateMessage(() -> Component.translatable("gui.void_dimension.terminal.page1.bound_dim_value", "§b" + GuiS2CPacket.getBoundDim()))
                .alignLeft();
        ...
        TickAbstractWidget anchorPosValueLabel = new TickString(
                ...
                .updateMessage(() -> {
                    BlockPos pos = BlockPos.of(GuiS2CPacket.getBoundPos());
                    return Component.translatable("gui.void_dimension.terminal.page1.bound_anchor_pos_value", "§c" + pos.getX(), "§a" +  pos.getY(), "§9" + pos.getZ());
                })
                .alignLeft();
        ...
        TickAbstractWidget boundPowerLabel = new TickString(
                ...
                .updateMessage(() -> Component.translatable("gui.void_dimension.terminal.page1.bound_anchor_power_level", "§b" + GuiS2CPacket.getAnchorPowerLevel()))
                .alignLeft();
